...
The following example shows median household income from the 2020-2024 ACS for Census tracts in Orange County, California:
...
As the dataset is in a tidy format, it can be quickly visualized with `geom_sf()` from __ggplot2__:
